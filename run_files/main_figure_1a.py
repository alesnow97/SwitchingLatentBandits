...
import utils
from simulations.estimation_error_figure_1a import EstimationErrorFigure1a
...
if __name__ == '__main__':
    ...
    bandit_to_load_path = os.path.join(
        utils.get_base_path(),
        "experiments/estimation_error_figure_1a",
    ...
    experiments = EstimationErrorFigure1a(switching,
    ...
    experiments.run(starting_checkpoint=starting_checkpoint,
                    ...
                    num_selected_arms_list=num_selected_arms_list)
