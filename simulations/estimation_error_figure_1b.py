import utils
from policies.our_policy_figure_1b import OurPolicyFigure1b
...
class EstimationErrorFigure1b:
    ...
    def generate_dirs(self):
        utils.set_base_path()
        dir_name = f"experiments/estimation_error_figure_1b/{self.switching_env.num_states}states_{self.switching_env.num_actions}actions_{self.switching_env.num_obs}obs"
    ...
    def run(self, starting_checkpoint, num_checkpoints, checkpoint_duration):
        ...
        our_policy = OurPolicyFigure1b(switching_env=self.switching_env,
