...
class OurPolicyMisspecifiedFigure5:
    ...
    def reset(self, misspecified_reference_matrix):
    ...
    def estimate_transition_matrix(self):
        ...
        flatten_transition_distribution = np.linalg.lstsq(self.misspecified_reference_matrix, self.expected_visit_vector, rcond=None)[0]
        ...
        self.estimation_errors[update_index] = [self.t, frobenious_norm]
